...
public class PairingCockpitCrew implements Serializable {
    ...
    private FlightCrew cockpitCrew;
    ...
    /**
     * @return the cockpitCrew
     */
    public FlightCrew getCockpitCrew() {
        return cockpitCrew;
    }

    /**
     * @param cockpitCrew the cockpitCrew to set
     */
    public void setCockpitCrew(FlightCrew cockpitCrew) {
