 ...
 * @author weiming
 */
@Named(value = "crmMobileNavController")
@RequestScoped
public class CrmMobileNavController implements Serializable {

    private final String REDIRECT = "?faces-redirect=true";
    private final String CRM_URL = "/views/external/unsecured/crm_mobile/";
    ...
    //Flight Booking
    public String redirectToSearchFlight() {
        return CRM_URL + "flight_booking/search.xhtml" + REDIRECT;
    }
    ...
    public String redirectToTixFamSelection() {
        return CRM_URL + "flight_booking/tixFamSelection.xhtml" + REDIRECT;
    }
