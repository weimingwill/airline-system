 ...
 * @author weiming
 */
@Named(value = "ddsNavController")
@RequestScoped
public class DdsNavController implements Serializable {
    private final String REDIRECT = "?faces-redirect=true";
    private final String ARS_URL = "/views/internal/secured/dds/";
    /**
     * Creates a new instance of ArsNavController
     */
    public DdsNavController() {
    }
    
    public String redirectToDDS() {
